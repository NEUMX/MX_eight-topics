...
![1732497574526-c727dfd7-88b9-41df-8e2c-fe4c31eede6d.png](./img/3V94F3M1mY7gefTZ/1732497574526-c727dfd7-88b9-41df-8e2c-fe4c31eede6d-527429.png)
...
我们这里会用到[反编译](https://mp.weixin.qq.com/s?__biz=MzI3NzE0NjcwMg==&mid=2650120609&idx=1&sn=5659f96310963ad57d55b48cee63c788&chksm=f36bbc80c41c3596a1e4bf9501c6280481f1b9e06d07af354474e6f3ed366fef016df673a7ba&scene=21#wechat_redirect)[open in new window](https://mp.weixin.qq.com/s?__biz=MzI3NzE0NjcwMg==&mid=2650120609&idx=1&sn=5659f96310963ad57d55b48cee63c788&chksm=f36bbc80c41c3596a1e4bf9501c6280481f1b9e06d07af354474e6f3ed366fef016df673a7ba&scene=21#wechat_redirect)，你可以通过[Decompilers online](http://www.javadecompilers.com/)[open in new window](http://www.javadecompilers.com/)对 Class 文件进行在线反编译。
...
看到这个代码，你知道原来*_字符串的 switch 是通过_***equals()**和**hashCode()****方法来实现的。**还好hashCode()方法返回的是int，而不是long。
...
上面这段代码，有两个重载的函数，因为他们的参数类型不同，一个是List另一个是List，但是，这段代码是编译通不过的。因为我们前面讲过，参数List和List编译之后都被擦除了，变成了一样的原生类型 List，擦除动作导致这两个方法的特征签名变得一模一样。
...
> 更新: 2024-01-02 20:03:44  
原文: [https://www.yuque.com/vip6688/neho4x/aplogbfk2cwokx0d](https://www.yuque.com/vip6688/neho4x/aplogbfk2cwokx0d)
>



> 更新: 2024-11-25 09:19:35  
> 原文: <https://www.yuque.com/neumx/laxg2e/94c1201d4dce9e7e18774a89f04e46ed>