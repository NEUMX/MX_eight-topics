...
如果一定要使用，建议把 BLOB 或是 TEXT 列分离到单独的扩展表中，查询时一定不要使用select *而只需要取出必要的列，不需要 TEXT 列的数据时不要对该列进行查询。
...
相关阅读：[是否推荐使用 MySQL 的 enum 类型？ - 架构文摘 - 知乎](https://www.zhihu.com/question/404422255/answer/1661698499)[](https://www.zhihu.com/question/404422255/answer/1661698499)。
...
相关阅读：[技术分享 | MySQL 默认值选型（是空，还是 NULL）](https://opensource.actionsky.com/20190710-mysql/)[](https://opensource.actionsky.com/20190710-mysql/)。
...
MySQL 时间类型选择的详细介绍请看这篇：[MySQL 时间类型数据存储建议](https://javaguide.cn/database/mysql/some-thoughts-on-database-storage-time.html)[](https://javaguide.cn/database/mysql/some-thoughts-on-database-storage-time.html)。
...
> 更新: 2024-01-29 19:13:19  
原文: [https://www.yuque.com/vip6688/neho4x/lqovlxlqfn9iiatb](https://www.yuque.com/vip6688/neho4x/lqovlxlqfn9iiatb)
>



> 更新: 2024-11-25 09:20:13  
> 原文: <https://www.yuque.com/neumx/laxg2e/d595f7a17ac2a01bb169cca96bd22de0>