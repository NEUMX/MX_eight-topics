...
另外，不要下意识地认为LinkedList作为链表就最适合元素增删的场景。我在上面也说了，LinkedList仅仅在**<font style="background-color:#d9eafc;">头尾插入或者删除元素的时候时间复杂度近似 O(1)</font>**，其他情况增删元素的平均时间复杂度都是 O(n) 。
